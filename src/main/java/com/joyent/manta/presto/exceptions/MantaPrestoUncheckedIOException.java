...
public class MantaPrestoUncheckedIOException extends UncheckedIOException
    ...
    private static final long serialVersionUID = -6208534269967329389L;
    ...
    public MantaPrestoUncheckedIOException(final String message,
                                           final IOException cause) {
        super(message, cause);
        this.exceptionContext = new DefaultExceptionContext();
    }

    public MantaPrestoUncheckedIOException(final IOException cause) {
        super(cause);
        this.exceptionContext = new DefaultExceptionContext();
    }
